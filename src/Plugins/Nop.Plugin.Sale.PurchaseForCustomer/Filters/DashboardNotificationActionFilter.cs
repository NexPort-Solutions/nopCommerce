...
public sealed class DashboardNotificationActionFilter : IAsyncActionFilter
{
    ...
    public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
    {
        ...
        var hasModifiedLocaleResources =
            await _settingService.GetSettingByKeyAsync("Plugin.Sale.PurchaseForCustomer.HasModifiedLocaleResources", false);
        ...
        var warningTemplate = await _localizationService.GetResourceAsync("Plugins.Sale.PurchaseForCustomer.Errors.ModifiedLocaleResources");
