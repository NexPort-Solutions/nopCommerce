...
public interface IRegistrationFieldCustomRender : IPlugin
{
    ...
    Task SaveCustoms(Customer customer, int fieldId, Dictionary<string, string> fields);
    ...
    Task UpdateCustomAnswers(int customerId, int fieldId, Dictionary<string, string> fields);
}
