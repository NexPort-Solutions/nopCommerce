...
public class NexportPluginService
{
    ...
    private static readonly Dictionary<string, string> _localeResources = new()
    {
        ...
        { "Plugins.Misc.Nexport.Group.Product.Redemptions.Redeem.AssignmentType", "AssignmentType" },
        ...
        { "Plugins.Misc.Nexport.Group.Product.Redemption.Name", "Customer Name" },
        { "Plugins.Misc.Nexport.Group.Product.Redemption.Email", "Customer Email" },
        { "Plugins.Misc.Nexport.Group.Product.Redemption.ProductName", "Product Name" },
        ...
        { "Plugins.Misc.Nexport.Group.Product.SearchName", "Name" },
        { "Plugins.Misc.Nexport.Group.Product.SearchName.Hint", "Search by product name" },
        { "Plugins.Misc.Nexport.Group.Product.Redemption.SearchName", "Name" },
        { "Plugins.Misc.Nexport.Group.Product.Redemption.SearchName.Hint", "Search by customer name" },
        { "Plugins.Misc.Nexport.Group.Product.Redemption.SearchEmail", "Email" },
        { "Plugins.Misc.Nexport.Group.Product.Redemption.SearchEmail.Hint", "Search by customer email" },
